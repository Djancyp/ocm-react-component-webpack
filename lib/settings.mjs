...
export default class SettingsLayout extends React.Component {
  ...
  render(props, state) {
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    }, "Image Width"), /*#__PURE__*/React.createElement("input", {
      id: "width",
      onChange: this.onWidthChange,
      onBlur: this.updateState,
      value: this.state.width,
      placeholder: "example: 200px or 33%",
      ...
      for: "titleText",
      className: "settings-heading"
    }, "Title Text"), /*#__PURE__*/React.createElement("input", {
      id: "titleText",
      onChange: this.onTitleTextTextChange,
      onBlur: this.updateState,
      value: this.state.nls.titleText,
      placeholder: "example: Template Component",
      className: "settings-text-box",
      style: {
        marginBottom: "10px"
      }
      ...
      for: "paragraphText",
      className: "settings-heading"
    }, "Description Text"), /*#__PURE__*/React.createElement("textarea", {
      id: "paragraphText",
      ...
      onBlur: this.updateState,
      value: this.state.nls.paragraphText,
      className: "settings-text-box"
    }), /*#__PURE__*/React.createElement("label", {
      for: "linkText",
      className: "settings-heading"
      ...
      for: "linkURL",
      className: "settings-heading"
    }, "Link URL"), /*#__PURE__*/React.createElement("textarea", {
      id: "linkURL",
